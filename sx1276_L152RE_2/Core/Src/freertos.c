...
QueueHandle_t xQueueUartData;
/* USER CODE END Variables */
osThreadId defaultTaskHandle;
osThreadId vRadioChDataHandle;
osThreadId vUartDataHandle;
...
/* USER CODE BEGIN Header_StartRadioChData */
/**
* @brief Function implementing the vRadioChData thread.
* @param argument: Not used
* @retval None
*/
...
void StartRadioChData(void const * argument)
{
  ...
  /* USER CODE END StartRadioChData */
}

/* USER CODE BEGIN Header_StartUartData */
/**
* @brief Function implementing the vUartData thread.
* @param argument: Not used
* @retval None
*/
