...
typedef struct
{
  void    ( *dio0 )( void *context);
  void    ( *dio1 )( void *context);
  void    ( *dio2 )( void *context);
  void    ( *dio3 )( void *context);
  void    ( *dio4 )( void *context);
  void    ( *dio5 )( void *context);
}SX1276_DIO_callbacks_t;


//
//#define DIO_0 GPIO_PIN_14
